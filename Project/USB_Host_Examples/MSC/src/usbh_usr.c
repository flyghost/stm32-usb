...
__IO uint8_t g_UPanWriteFlag;
__IO uint8_t g_UPanReadFlag;
...
int USBH_USR_MSC_Application(void)
{
    ...
    if (g_UPanReadFlag == 1)
    {
        ...
        if (f_open(&file, "0:STM32.TXT", FA_OPEN_EXISTING | FA_READ) == FR_OK)
        {
...
* @retval Status
*/
int USBH_USR_MSC_Application1(void)
{
    FRESULT res;
    uint8_t writeTextBuff[] =
        "STM32 Connectivity line Host Demo application using FAT_FS   ";
